...
var __webpack_modules__ = ([
    ...
    /***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        class CompareEngine {
            ...
            findArrayDiffLevels(panel, path, level = 0, diffs = [], logEnabled = false) {
            ...
            comparePropertyValues(panel, sideValue, otherSideObject, propertyPath, logEnabled = false) {
                if (logEnabled) {
            ...
            compare(panel, sideValue, path = new _path_js__WEBPACK_IMPORTED_MODULE_3__.Path()) {
                let otherSideValue, logEnabled = this._logEnabled;
                    ...
                    arrayDiffLevels.forEach((arrayDiffLevel) => {
                        ...
                        if (_compare_utils_js__WEBPACK_IMPORTED_MODULE_2__.CompareUtils.isArray(otherSideItems)) {
                            if (arrayDiffLevel === 0) {
                                ...
                                compareState = this.comparePropertyValues(panel, currentSideValue, currentOtherRoot, arrayPath, logEnabled);
                            } else {
                                ...
                                if (otherSideObject) {
                                    ...
                                    if (arrayDiffLevel === 1) {
                                        ...
                                        compareState = this.comparePropertyValues(panel, currentSideValue, otherSideObject, propertyPath, logEnabled);
                                    }
