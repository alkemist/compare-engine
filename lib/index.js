define("compare-state.enum", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    exports.CompareStateEnum = void 0;
    ...
    })(CompareStateEnum = exports.CompareStateEnum || (exports.CompareStateEnum = {}));
});
define("compare-state", ["require", "exports", "compare-state.enum"], function (require, exports, compare_state_enum_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    exports.CompareState = void 0;

    class CompareState {
        constructor(_value = compare_state_enum_1.CompareStateEnum.NONE) {
            this._value = _value;
        }
        ...
        static get ADDED() {
            return new CompareState(compare_state_enum_1.CompareStateEnum.ADDED);
        }

        static get UPDATED() {
            return new CompareState(compare_state_enum_1.CompareStateEnum.UPDATED);
        }

        static get REMOVED() {
            return new CompareState(compare_state_enum_1.CompareStateEnum.REMOVED);
        }

        static get EQUAL() {
            return new CompareState(compare_state_enum_1.CompareStateEnum.EQUAL);
        }
        ...
        get isNone() {
            return this._value === compare_state_enum_1.CompareStateEnum.NONE;
        }

        get isAdded() {
            return this._value === compare_state_enum_1.CompareStateEnum.ADDED;
        }

        get isUpdated() {
            return this._value === compare_state_enum_1.CompareStateEnum.UPDATED;
        }

        get isRemoved() {
            return this._value === compare_state_enum_1.CompareStateEnum.REMOVED;
        }

        get isEqual() {
            return this._value === compare_state_enum_1.CompareStateEnum.EQUAL;
        }
...
define("panel.enum", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    exports.PanelEnum = void 0;
    var PanelEnum;
    (function (PanelEnum) {
        PanelEnum["LEFT"] = "left";
        PanelEnum["RIGHT"] = "right";
    })(PanelEnum = exports.PanelEnum || (exports.PanelEnum = {}));
});
define("value.interface", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
});
define("type-state", ["require", "exports", "compare-utils"], function (require, exports, compare_utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    exports.TypeState = exports.TypeStateEnum = void 0;
    var TypeStateEnum;
    ...
    })(TypeStateEnum = exports.TypeStateEnum || (exports.TypeStateEnum = {}));

    class TypeState {
        constructor(_value) {
            if (_value === undefined || _value === null) {
                this._type = TypeStateEnum.NO_EVALUABLE;
            } else if (compare_utils_1.CompareUtils.isArray(_value)) {
                this._type = TypeStateEnum.ARRAY;
            } else if (compare_utils_1.CompareUtils.isRecord(_value)) {
                this._type = _value.constructor.name === "Object"
                    ? TypeStateEnum.RECORD
                    : TypeStateEnum.OBJECT;
            } else if (compare_utils_1.CompareUtils.isFunction(_value)) {
...
define("compare-utils", ["require", "exports", "type-state"], function (require, exports, type_state_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    ...
    class CompareUtils {
        ...
        static isEqual(sideValue, otherSideValue) {
            const typeStateSideValue = new type_state_1.TypeState(sideValue);
            let typeStateOtherSideValue = new type_state_1.TypeState(sideValue);
        ...
        static flat(value) {
            const typeState = new type_state_1.TypeState(value);
...
define("finded-item.interface", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
});
...
define("compare-engine", ["require", "exports", "compare-state", "panel.enum", "compare-utils", "path"], function (require, exports, compare_state_1, panel_enum_1, compare_utils_2, path_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    exports.CompareEngine = void 0;
    ...
    class CompareEngine {
        ...
        updateLeft(value) {
            this.update(panel_enum_1.PanelEnum.LEFT, value);
        }

        updateRight(value) {
            this.update(panel_enum_1.PanelEnum.RIGHT, value);
        }

        updateCompareIndex() {
            this.compareStateIndex[panel_enum_1.PanelEnum.LEFT].clear();
            this.compareStateIndex[panel_enum_1.PanelEnum.RIGHT].clear();
            this.compare(panel_enum_1.PanelEnum.LEFT, this.panels[panel_enum_1.PanelEnum.LEFT]);
            this.compare(panel_enum_1.PanelEnum.RIGHT, this.panels[panel_enum_1.PanelEnum.RIGHT]);
        }
        ...
        getLeftState(path) {
            return this.getState(panel_enum_1.PanelEnum.LEFT, path);
        }

        getRightState(path) {
            return this.getState(panel_enum_1.PanelEnum.RIGHT, path);
        }

        getState(panel, path) {
            return this.compareStateIndex[panel].get(compare_utils_2.CompareUtils.isArray(path) ? path.join("/") : path) ?? compare_state_1.CompareState.NONE;
        }
        ...
        findCompareItem(sideValue, otherSideItems, searchKey) {
            let itemIndex;
            if (searchKey && compare_utils_2.CompareUtils.isRecord(sideValue) && compare_utils_2.CompareUtils.hasProperty(sideValue, [searchKey])) {
        ...
        comparePropertyValues(panel, sideValue, otherSideObject, propertyPath, showLog = false) {
            if (showLog) {
                console.log('--- Compare property value', propertyPath, compare_utils_2.CompareUtils.hasProperty(otherSideObject, propertyPath) ? "exist" : "not exist");
                console.log('--- in object', otherSideObject);
            }
            if (!compare_utils_2.CompareUtils.hasProperty(otherSideObject, propertyPath)) {
                return this.getIncomparableState(panel);
            }
            const currentOtherSideValue = compare_utils_2.CompareUtils.getIn(otherSideObject, propertyPath);
            if (showLog) {
                console.log('--- Is equal ?', compare_utils_2.CompareUtils.isEqual(sideValue, currentOtherSideValue));
                console.log('--- Other side value', currentOtherSideValue);
            }
            return compare_utils_2.CompareUtils.isEqual(sideValue, currentOtherSideValue)
                ? compare_state_1.CompareState.EQUAL
                : compare_state_1.CompareState.UPDATED;
        }

        getIncomparableState(panel) {
            return panel === panel_enum_1.PanelEnum.LEFT ? compare_state_1.CompareState.REMOVED : compare_state_1.CompareState.ADDED;
        }

        compareValues(panel, sideValue, otherSideValue) {
            return compare_utils_2.CompareUtils.isEqual(sideValue, otherSideValue)
                ? compare_state_1.CompareState.EQUAL
                : compare_state_1.CompareState.UPDATED;
        }
        ...
        compare(panel, sideValue, path = new path_1.Path()) {
            let showLog = false;
            let otherSideValue, compareState = compare_state_1.CompareState.NONE;
            const otherPanel = panel === panel_enum_1.PanelEnum.LEFT ? panel_enum_1.PanelEnum.RIGHT : panel_enum_1.PanelEnum.LEFT;
            if (!compare_utils_2.CompareUtils.isPrimitive(sideValue)) {
                this.arrayIndex[panel].set(path.toString(), compare_utils_2.CompareUtils.isArray(sideValue));
            }
            ...
            let currentPath = compare_utils_2.CompareUtils.deepClone(path);
            let currentSideValue = compare_utils_2.CompareUtils.deepClone(sideValue);
            if (arrayDiffLevels.length > 0) {
                arrayDiffLevels.forEach((arrayDiffLevel) => {
                    ...
                    const otherSideItems = compare_utils_2.CompareUtils.getIn(currentOtherRoot, arrayPath);
                    if (showLog) {
                        ...
                        console.log('--- Other side is array ?', compare_utils_2.CompareUtils.isArray(otherSideItems));
                    }
                    if (compare_utils_2.CompareUtils.isArray(otherSideItems)) {
                        if (arrayDiffLevel === 0) {
                            currentSideValue = compare_utils_2.CompareUtils.getIn(currentRoot, arrayPath);
                            if (showLog) {
                            ...
                            const sideObject = compare_utils_2.CompareUtils.getIn(currentRoot, objectPath);
                            ...
                            if (otherSideObject) {
                                ...
                                if (arrayDiffLevel === 1) {
                                    ...
                                    currentSideValue = compare_utils_2.CompareUtils.getIn(sideObject, propertyPath);
                                    if (showLog) {
                                    ...
                                    compareState = compareIndex.isUpdated || compareValue.isUpdated
                                        ? compare_state_1.CompareState.UPDATED : compare_state_1.CompareState.EQUAL;
                                } else {
                                    currentSideValue = compare_utils_2.CompareUtils.getIn(sideObject, propertyPath);
                                    otherSideValue = compare_utils_2.CompareUtils.getIn(otherSideObject, propertyPath);
                                    if (showLog) {
                                        console.log('-- Array diff > 1', propertyPath);
                                ...
                                currentPath = compare_utils_2.CompareUtils.deepClone(propertyPath);
                                currentRoot = compare_utils_2.CompareUtils.deepClone(sideObject);
                                currentSideValue = compare_utils_2.CompareUtils.deepClone(sideObject);
                                currentOtherRoot = compare_utils_2.CompareUtils.deepClone(otherSideObject);
                                otherSideValue = compare_utils_2.CompareUtils.deepClone(otherSideObject);
                            } else {
                ...
                otherSideValue = compare_utils_2.CompareUtils.getIn(this.panels[otherPanel], path);
            ...
            if (compareState.isUpdated && compare_utils_2.CompareUtils.isTree(sideValue)) {
                const items = compare_utils_2.CompareUtils.isArray(sideValue)
                    ? sideValue.map((_, index) => index.toString())
                    : Object.keys(sideValue);
                items.forEach((index) => {
                    const subPath = path.clone().add(index);
                    const subSideValue = compare_utils_2.CompareUtils.isArray(sideValue) ?
    ...
    exports.CompareEngine = CompareEngine;
});
define("test-data", ["require", "exports", "type-state"], function (require, exports, type_state_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    exports.testValues = void 0;
    const voidFunction = () => {
    };
    const voidFunctionSerialized = "() => {\n" +
        "}";
    const paramsFunction = (param, callback) => true;
    ...
    class ParentTest {
        ...
        constructor(propertyOverride, propertyUndefined = undefined, propertyNull = null, propertyZero = 0, propertyOne = 1, propertyTwo = 2, propertyTwoPointOne = 2.1, propertyTrue = true, propertyRecord, voidFn, paramsFn, classicFn, asyncFn) {
            this.propertyOverride = propertyOverride;
            this.propertyUndefined = propertyUndefined;
            this.propertyNull = propertyNull;
            this.propertyZero = propertyZero;
            this.propertyOne = propertyOne;
            this.propertyTwo = propertyTwo;
            this.propertyTwoPointOne = propertyTwoPointOne;
            this.propertyTrue = propertyTrue;
            this.propertyRecord = propertyRecord;
            this.voidFn = voidFn;
            this.paramsFn = paramsFn;
            this.classicFn = classicFn;
    ...
    const objectFunction = (promiseCallback) => ParentTest;
    ...
    class ChildTest extends ParentTest {
        ...
        constructor(propertyOverride, propertyObject = new ParentTest("x")) {
    ...
    exports.testValues = [
        {
            name: "undefined",
            value: undefined,
            expectedType: type_state_2.TypeStateEnum.NO_EVALUABLE,
            expectedSerialize: "undefined"
        },
        {name: "null", value: null, expectedType: type_state_2.TypeStateEnum.NO_EVALUABLE, expectedSerialize: "null"},
        {name: "true", value: true, expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: "true"},
        {name: "false", value: false, expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: "false"},
        {name: "0", value: 0, expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: "0"},
        {name: "1", value: 1, expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: "1"},
        {name: "2", value: 2, expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: "2"},
        {name: "2.1", value: 2.1, expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: "2.1"},
        {name: "", value: "", expectedType: type_state_2.TypeStateEnum.PRIMITIVE, expectedSerialize: '""'},
        {
            name: "string",
            value: "string",
            expectedType: type_state_2.TypeStateEnum.PRIMITIVE,
            expectedSerialize: '"string"'
        },
        {name: "[]", value: [], expectedType: type_state_2.TypeStateEnum.ARRAY, expectedSerialize: "[]"},
        {
            name: '[{property: "value"}]',
            value: [{property: "value"}],
            expectedType: type_state_2.TypeStateEnum.ARRAY,
            expectedSerialize: '[{"property":"\\\"value\\\""}]'
        },
        {
            name: '{property: "value"}',
            value: {property: "value"},
            expectedType: type_state_2.TypeStateEnum.RECORD,
            expectedSerialize: '{"property":"\\\"value\\\""}'
        },
        {
            name: "voidFunction",
            value: voidFunction,
            expectedType: type_state_2.TypeStateEnum.FUNCTION,
        ...
        },
        {
            ...
            expectedType: type_state_2.TypeStateEnum.OBJECT,
